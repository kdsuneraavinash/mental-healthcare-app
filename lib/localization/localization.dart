...
abstract class CustomLocalization {
  String get app_name;
  String get clinicLocationsAppBarTitle;
  ...
  String get clinicLocationsGrantAccess;
  String clinicLocationsDescriptionTitle(String startTime, String endTime);
}
...
class En implements CustomLocalization {
  ...
  String get clinicLocationsAppBarTitle => "Clinic Locations";
  String get consultantsAppBarTitle =>
  ...
  String get homePageDrawerClinics => "Clinic Locations";
  String get homePageDrawerClinicsDescription => "View Mental Health Clinics";
  ...
  String get clinicLocationsGrantAccess => "Grant Location Access";
  String clinicLocationsDescriptionTitle(String startTime, String endTime) =>
...
class Si implements CustomLocalization {
  ...
  String get clinicLocationsAppBarTitle => "සායන ඇති ස්ථාන";
  ...
  String get homePageDrawerClinicsDescription => "මානසික වෛද්‍ය සායන ඇති ස්ථාන";
  String get homePageDrawerConsultants => "මනෝ වෛද්‍යවරුන් හා උපදේශකවරුන්";
  String get homePageDrawerConsultantsDescription =>
      "ඔබගේ ගැටලුවට පිලිතුරු සොයාගන්න";
...
class Ta implements CustomLocalization {
  ...
  String get clinicLocationsAppBarTitle => "மருத்துவ இடங்கள்";
  String get consultantsAppBarTitle =>
  ...
  String get clinicLocationsGrantAccess => "இருப்பிட அணுகலை வழங்குதல்";
  String clinicLocationsDescriptionTitle(String startTime, String endTime) =>
      "நேரம் $startTime : $endTime";
}
